...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile) {
      ...
      //Bring skills array bak to CSV
      const skillsCSV = profile.skills.join(",");

      //If profile field doesnt exists
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.handle}
                  info="A unique haandle for your profile URL, Your full name,company name,nickname"
                />
                <SelectListGroup
                  placeholder="Status"
                  name="status"
                ...
                <TextFieldGroup
                  ...
                  info="Could be your own webiste or one you work on"
                />
                <TextFieldGroup
                  placeholder="Website"
                  name="website"
                ...
                <TextFieldGroup
                  ...
                  info="The location where you live"
                />
                <TextFieldGroup
                  placeholder="* Skills"
                  name="skills"
